...
public class BetslipBottomSheet extends BottomSheet {
    ...
    public BetslipBottomSheet(Context context, Object parentObject) {
        super(context, false);
    ...
    public BetslipBottomSheet(Context context, BaseFragment baseFragment, List<String> set) {
        super(context, false);
    ...
    private void init(Context context) {
        containerView = new FrameLayout(context) {
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                contentSize = 100;//AndroidUtilities.dp(48 + 48) + Math.max(3, (stickerSet != null ? (int) Math.ceil(stickerSet.documents.size() / 5.0f) : 0)) * AndroidUtilities.dp(82) + backgroundPaddingTop + AndroidUtilities.statusBarHeight;
